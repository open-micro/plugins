...
The grpc server is a [micro.Server](https://pkg.go.dev/github.com/open-micro/go-micro/server#Server) compatible server.
...
import (
        "go-micro.org/v5"
        "github.com/open-micro/plugins/v5/server/grpc"
)
