...
import (
	...
	"go-micro.org/v5/errors"
	"go-micro.org/v5/registry"
	"go-micro.org/v5/server"
	"go-micro.org/v5/transport"

	gcli "github.com/open-micro/plugins/v5/client/grpc"
	gsrv "github.com/open-micro/plugins/v5/server/grpc"
	pb "github.com/open-micro/plugins/v5/server/grpc/proto"
	tgrpc "github.com/open-micro/plugins/v5/transport/grpc"
)
