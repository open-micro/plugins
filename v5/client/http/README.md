...
It complies with the [go-micro.Client](https://godoc.org/github.com/open-micro/go-micro/client#Client) interface.
...
```go
import "github.com/open-micro/plugins/v5/client/http"
...
```go
import _ "github.com/open-micro/plugins/v5/client/http"
```
