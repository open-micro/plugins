...
import (
	_ "github.com/open-micro/plugins/v5/broker/rabbitmq"
	_ "github.com/open-micro/plugins/v5/registry/kubernetes"
	_ "github.com/open-micro/plugins/v5/transport/nats"
)
```
...
import (
	"go-micro.org/v5"
	"github.com/open-micro/plugins/v5/registry/kubernetes"
)
...
- [Slack](https://join.slack.com/t/open-micro/shared_invite/zt-175aaev1d-iHExPTlfxvfkOeeKLIYEYw)
